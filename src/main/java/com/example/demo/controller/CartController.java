...
public class CartController {
	...
	public ResponseEntity<String> addMedicinesToCart( @RequestBody CartDTO customerCartDTO) throws EpharmacyException {
	...
	public ResponseEntity<Set<ProductDTO>> getMedicinesFromCart(@PathVariable String email) throws EpharmacyException {
	...
	public ResponseEntity<String> deleteAllMedicinesFromCart(@PathVariable String email) throws EpharmacyException {
